  ...
  render(list, todoInstance) {
    ...
    list.forEach((todo) => {
      ...
      if (todo.isEditing) {
        ...
        dotBtn.classList = 'dropdown-toggle px-1 py-1 bg-slate-100 text-gray-400 font-medium text-xs leading-tight rounded shadow-md hover:bg-slate-300 hover:shadow-lg focus:bg-slate-300 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-slate-300 active:shadow-lg active:text-white transition duration-150 ease-in-out flex items-center whitespace-nowrap';
        ...
        <span>DEL</span>`;
        delBtn.classList = 'del-btn dropdown-item flex items-center space-x-2 text-sm py-2 px-4 font-normal w-full whitespace-nowrap bg-transparent text-gray-700 transition duration-150 hover:bg-red-500 hover:text-white';
        ...
        <span>EDIT</span>`;
        editBtn.classList = 'edit-btn dropdown-item flex items-center space-x-2 text-sm py-2 px-4 font-normal w-full whitespace-nowrap bg-transparent text-gray-700 transition duration-150 hover:bg-amber-500 hover:text-white';
        ...
        dropMenu.classList = 'dropdown-menu min-w-max absolute hidden bg-white text-base z-50 float-left right-full py-2 list-none text-left rounded-lg shadow-lg mt-1 m-0 bg-clip-padding border-none';
